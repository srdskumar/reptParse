...
public class ParseCreditorTransactionsData {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<String> settled = parseReport("Settled Transactions-Funds-Paid",0,1,5,4,25,27,"settled");
        ArrayList<String> alloc = parseReport("Cash Allocations",9,10,11,12,23,25,"alloc");
        ArrayList<String> writeoff = parseReport("Write_off",9,10,11,12,23,25,"writeoff");
    ...
    public static ArrayList<String> parseReport(String name,int c1,int c2,int c3,int c4,int c5,int c6,String tbl) throws IOException
    {
        ...
        while (iterator.hasNext()) {
            ...
            while (cellIterator.hasNext()) {
                ...
                if( cell.getColumnIndex() == 32 || cell.getColumnIndex() == c1 || cell.getColumnIndex() == c2 || cell.getColumnIndex() == c3 || cell.getColumnIndex() == c4 || cell.getColumnIndex() == c5 || cell.getColumnIndex() == c6)  
                {
